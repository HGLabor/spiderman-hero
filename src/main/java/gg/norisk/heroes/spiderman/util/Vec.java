package gg.norisk.heroes.spiderman.util;
...
public class Vec {
    ...
    public NbtList toNBT() {
        ...
        listTag.add(NbtDouble.of(this.x));
        listTag.add(NbtDouble.of(this.y));
        listTag.add(NbtDouble.of(this.z));
        return listTag;
    }
